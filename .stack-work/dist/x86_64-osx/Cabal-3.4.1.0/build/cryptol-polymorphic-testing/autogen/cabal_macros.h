...
/* package cryptol-polymorphic-testing-0.1.0.0 */
#ifndef VERSION_cryptol_polymorphic_testing
#define VERSION_cryptol_polymorphic_testing "0.1.0.0"
#endif /* VERSION_cryptol_polymorphic_testing */
#ifndef MIN_VERSION_cryptol_polymorphic_testing
#define MIN_VERSION_cryptol_polymorphic_testing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cryptol_polymorphic_testing */
...
#define CURRENT_COMPONENT_ID "cryptol-polymorphic-testing-0.1.0.0-1YeCOtQzulRKM6tiPfmqPM-cryptol-polymorphic-testing"
